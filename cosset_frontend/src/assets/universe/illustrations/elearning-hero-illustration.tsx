...
const iconPath = (name: string) => `${CONFIG.universe.assetsDir}/assets/icons/banner/${name}`;
...
function ElearningHeroIllustration({ sx, ...other }: BoxProps) {
  ...
  const renderCharacter = (
    <Box
      component="img"
      alt="Teacher hero"
      src={`${CONFIG.universe.assetsDir}/assets/images/course/teacher-hero.webp`}
      sx={{
        ...baseStyles,
        right: 18,
        width: 546,
    ...
    >
      <FloatLabel
        ...
        sx={{
          ...
          color: '#2994FF',
          fontWeight: 'fontWeightBold',
          boxShadow: `0px 24px 48px rgba(0, 0, 0, 0.24), inset 0px -4px 10px ${varAlpha(
