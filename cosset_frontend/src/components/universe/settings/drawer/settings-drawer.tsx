...
import { paper, varAlpha } from 'src/theme/universe/styles';
import { defaultFont } from 'src/theme/universe/core/typography';
import PRIMARY_COLOR from 'src/theme/universe/with-settings/primary-color.json';
import SECONDARY_COLOR from 'src/theme/universe/with-settings/secondary-color.json';
...
const PRESET_NAMES = ['default', 'preset1', 'preset2', 'preset3', 'preset4', 'preset5'] as const;
