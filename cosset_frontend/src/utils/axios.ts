...
export const endpoints = {
  ...
  auth: {
    ...
    recovery: {
      status: '/api/auth/recovery/status',
      phoneSendCode: '/api/auth/recovery/phone/send-code',
      phoneVerify: '/api/auth/recovery/phone/verify',
      securityQuestions: '/api/auth/recovery/security-questions',
      securityQuestionsCatalog: '/api/auth/recovery/security-questions/catalog',
      start: '/api/auth/recovery/start',
      verifyPhone: '/api/auth/recovery/verify-phone',
      verifyQuestions: '/api/auth/recovery/verify-questions',
      requestNewEmail: '/api/auth/recovery/request-new-email',
      confirmNewEmail: '/api/auth/recovery/confirm-new-email',
    },
  },
  billing: {
