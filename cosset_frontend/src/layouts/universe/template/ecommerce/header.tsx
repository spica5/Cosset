...
import { varAlpha, bgGradient } from 'src/theme/universe/styles';

import { Iconify } from 'src/components/universe/iconify';
import { MegaMenuMobile, MegaMenuHorizontal } from 'src/components/universe/mega-menu';
    ...
    <Box gap={3} display="flex" alignItems="center">
      <Badge badgeContent={2} color="info">
        <IconButton
          ...
          href={paths.universe.eCommerce.wishlist}
          color="inherit"
          sx={{ p: 0 }}
        >
      ...
      <Badge badgeContent={4} color="error">
        <IconButton
          disableRipple
          component={RouterLink}
          href={paths.universe.eCommerce.cart}
          color="inherit"
          sx={{ p: 0 }}
        >
    ...
    <Box
      ...
      sx={{
        ...bgGradient({
          ...
          imgUrl: `${CONFIG.universe.assetsDir}/assets/background/overlay-1.webp`,
        }),
      }}
    >
