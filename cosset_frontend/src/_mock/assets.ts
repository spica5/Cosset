...
export const _connections = [
  83, 97, 68, 85, 52, 25, 43, 60, 98, 53, 72, 56, 64, 77,
  60, 79, 93, 47, 76, 92, 72, 20, 94, 37,
];
...
export const _motifs = [
  `Ocean Blue · Soft Light`,
  `Warm Wood · Moon Glow`,
  `Green Leaves · Linen`,
  `Coffee Brown · Soft Beige`,
  `Deep Indigo · Stars`,
  `Cream · Spiral Forms`,
  `Blush Pink · Petals`,
  ...
  `Amber · Candlelight`,
  `Sunrise · Soft Yellow`,
  `Sunlit Linen · Dusty Gold`,
  `Pale Sky · Soft White`,
  `Paper Cream · Ink Blue`,
  `Muted Teal · Stone Grey`,
  `Shadow Black · Soft Amber`,
  `Soft Green · Morning Light`,
  `Frosted Glass · Silver`,
  `Lavender · Deep Blue`,
  `Soft Fabric · Warm Taupe`,
  `Pale Yellow · Mist`,
  `Natural Cream · Spiral Lines`,
  `Charcoal · Soft Neon`,
  `Cool Grey · Blue Reflections`,
  `Midnight Blue · Star Dust`,
]

export const _openness = [
  `Invite-Only`,
  `Private`,
  `Shared`,
  `Shared`,
