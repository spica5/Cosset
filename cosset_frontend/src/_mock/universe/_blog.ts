...
<p><img alt="Marketing image 1" src='${CONFIG.universe.assetsDir}/assets/images/${name}/${name}-large-2.webp' /></p>
...
<p><img alt="Marketing image 2" src='${CONFIG.universe.assetsDir}/assets/images/${name}/${name}-large-3.webp' /></p>
...
export const _marketingPosts = [...Array(12)].map((_, index) => ({
  ...
  heroUrl: `${CONFIG.universe.assetsDir}/assets/images/marketing/marketing-large-1.webp`,
}));

export const _universePosts = [...Array(12)].map((_, index) => ({
  ...base(index),
  content: content('universe'),
  coverUrl: _mock.image.universe(index),
  heroUrl: `${CONFIG.universe.assetsDir}/assets/images/universe/universe-large-1.webp`,
}));
...
export const _careerPosts = [...Array(12)].map((_, index) => ({
  ...
  heroUrl: `${CONFIG.universe.assetsDir}/assets/images/career/career-large-1.webp`,
}));
...
export const _coursePosts = [...Array(12)].map((_, index) => ({
  ...
  heroUrl: `${CONFIG.universe.assetsDir}/assets/images/course/course-large-1.webp`,
}));
