...
const ICONS = [
  `${CONFIG.universe.assetsDir}/assets/icons/solid-64/ic-finance.svg`,
  `${CONFIG.universe.assetsDir}/assets/icons/solid-64/ic-marketing-bullhorn.svg`,
  `${CONFIG.universe.assetsDir}/assets/icons/solid-64/ic-creativity.svg`,
  `${CONFIG.universe.assetsDir}/assets/icons/solid-64/ic-web-programming.svg`,
  `${CONFIG.universe.assetsDir}/assets/icons/solid-64/ic-chip.svg`,
  `${CONFIG.universe.assetsDir}/assets/icons/solid-64/ic-customer-service.svg`,
  `${CONFIG.universe.assetsDir}/assets/icons/solid-64/ic-stethoscope.svg`,
  `${CONFIG.universe.assetsDir}/assets/icons/solid-64/ic-banking.svg`,
];
